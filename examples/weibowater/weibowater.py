...
'''一个简单的微博水军机器人'''
class WeiboWater():
    def __init__(self, username='charlespikachu', password='微信公众号: Charles的皮卡丘', targetid=None, **kwargs):
...
if __name__ == '__main__':
    args = parseArgs()
    client = WeiboWater(username=args.username, password=args.password, targetid=args.targetid)
    client.run()